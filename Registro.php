...
// Consulta a la base de datos para obtener los estudiantes (solo los campos visibles)
...
if ($result->num_rows > 0) {
    ...
    echo "<a href='exportar_todos.php' class='btn btn-success'>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . htmlspecialchars($row['telefono_madre']) . "</td>";
        echo "<td>" . htmlspecialchars($row['telefono_padre']) . "</td>";
        echo "<td>" . htmlspecialchars($row['telefono_tutor']) . "</td>";
        echo "<td>" . htmlspecialchars($row['nombre_completo']) . "</td>";
        
        // Botones de acción (editar, eliminar, exportar a Excel)
        echo "<td>
            <!-- Icono de Editar -->
            <a href='editar.php?nombre=" . urlencode($row['nombre']) . "&apellido=" . urlencode($row['apellido']) . "' class='edit'>
            ...
            <a href='exportar_excel.php?nombre=" . urlencode($row['nombre']) . "&apellido=" . urlencode($row['apellido']) . "' class='export'>
    ...
    echo "<p class='text-center' id='noResultsMessage'>No hay estudiantes registrados.</p>";
}
